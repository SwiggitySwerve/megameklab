/**
 * Validation Orchestration Type Definitions
 * Shared types for validation orchestration and mediator services
 */
...
export interface ComplianceReport {
  ...
  ruleCompliance: any[] // Would be properly typed in real implementation
...
// Command pattern interfaces for validation execution
...
export interface ValidationMediator {
  addValidator(validator: ValidationCommand): void
  removeValidator(validatorName: string): void
  executeValidation(context: ValidationContext): Promise<ValidationOrchestrationResult>
  getValidationOrder(): string[]
  optimizeExecutionOrder(): void
}

export interface ValidationObserver {
  onValidationStart(validatorName: string): void
  onValidationComplete(validatorName: string, result: ValidationResult): void
  onValidationError(validatorName: string, error: Error): void
}