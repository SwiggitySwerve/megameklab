...
export const STRUCTURE_WEIGHT_MULTIPLIERS = {
    'Standard': 0.10,
    'Endo Steel': 0.05,
...
export const STRUCTURE_SLOT_REQUIREMENTS = {
    'Standard': 0,
    'Endo Steel': 14,
    'Endo Steel (Clan)': 7,
    'Composite': 0,
...
export const STRUCTURE_TECH_RESTRICTIONS = {
 ...
 */
export function calculateStructureWeight(mechTonnage, type) {
 ...
 */
export function getInternalStructureByLocation(mechTonnage) {
 ...
 */
export function getInternalStructurePoints(mechTonnage) {
 ...
 */
export function validateStructureType(type, techBase, rulesLevel) {
 ...
 */
export function getStructureCalculations(mechTonnage, type) {
    return {
