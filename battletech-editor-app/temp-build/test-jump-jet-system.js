...
const jumpJetCalculations_1 = require("./utils/jumpJetCalculations");
...
testMechs.forEach(mech => {
    ...
    const standardWeight = (0, jumpJetCalculations_1.calculateJumpJetWeight)('Standard Jump Jet', mech.tonnage, 1);
    console.log(`  Standard Jump Jet: ${standardWeight} tons each`);
    // Test other jump jet types
    const improvedWeight = (0, jumpJetCalculations_1.calculateJumpJetWeight)('Improved Jump Jet', mech.tonnage, 1);
    console.log(`  Improved Jump Jet: ${improvedWeight} tons each`);
    const extendedWeight = (0, jumpJetCalculations_1.calculateJumpJetWeight)('Extended Jump Jet', mech.tonnage, 1);
    console.log(`  Extended Jump Jet: ${extendedWeight} tons each`);
    const umuWeight = (0, jumpJetCalculations_1.calculateJumpJetWeight)('UMU', mech.tonnage, 1);
    console.log(`  UMU: ${umuWeight} tons each`);
    const mechanicalWeight = (0, jumpJetCalculations_1.calculateJumpJetWeight)('Mechanical Jump Booster', mech.tonnage, 1);
    console.log(`  Mechanical Jump Booster: ${mechanicalWeight} tons (for 1 MP only)`);
    const partialWingWeight = (0, jumpJetCalculations_1.calculateJumpJetWeight)('Partial Wing', mech.tonnage, 1);
...
testMechs.forEach(mech => {
    console.log(`\n${mech.name} (${mech.tonnage} tons):`);
    Object.entries(jumpJetCalculations_1.JUMP_JET_VARIANTS).forEach(([type, variant]) => {
        const jumpJetType = type;
        const slots = (0, jumpJetCalculations_1.calculateJumpJetCriticalSlots)(jumpJetType, mech.tonnage);
...
testMechs.forEach(mech => {
    ...
    Object.entries(jumpJetCalculations_1.JUMP_JET_VARIANTS).forEach(([type, variant]) => {
        const jumpJetType = type;
        const maxJumpMP = (0, jumpJetCalculations_1.getMaxAllowedJumpMP)(jumpJetType, mech.walkMP, mech.runMP);
...
const weight1 = (0, jumpJetCalculations_1.calculateTotalJumpJetWeight)(config1, 50, false);
const crits1 = (0, jumpJetCalculations_1.calculateTotalJumpJetCrits)(config1, 50);
const validation1 = (0, jumpJetCalculations_1.validateJumpJetConfiguration)(config1, 4, 4, 6, 50);
...
const weight2 = (0, jumpJetCalculations_1.calculateTotalJumpJetWeight)(config2, 50, false);
const validation2 = (0, jumpJetCalculations_1.validateJumpJetConfiguration)(config2, 6, 4, 6, 50);
...
const weight3 = (0, jumpJetCalculations_1.calculateTotalJumpJetWeight)(config3, 50, false);
const crits3 = (0, jumpJetCalculations_1.calculateTotalJumpJetCrits)(config3, 50);
const validation3 = (0, jumpJetCalculations_1.validateJumpJetConfiguration)(config3, 1, 4, 6, 50);
...
const validation4 = (0, jumpJetCalculations_1.validateJumpJetConfiguration)(config3, 2, 4, 6, 50);
...
const weight5WithoutWing = (0, jumpJetCalculations_1.calculateTotalJumpJetWeight)({ 'Standard Jump Jet': 4 }, 50, false);
const weight5WithWing = (0, jumpJetCalculations_1.calculateTotalJumpJetWeight)(config5, 50, true);
...
const weight6 = (0, jumpJetCalculations_1.calculateTotalJumpJetWeight)(config6, 50, false);
const crits6 = (0, jumpJetCalculations_1.calculateTotalJumpJetCrits)(config6, 50);
const validation6 = (0, jumpJetCalculations_1.validateJumpJetConfiguration)(config6, 4, 4, 6, 50);
...
Object.entries(jumpJetCalculations_1.JUMP_JET_VARIANTS).forEach(([type, variant]) => {
    ...
    const heat = (0, jumpJetCalculations_1.calculateJumpJetHeat)(config, 4);
...
Object.entries(jumpJetCalculations_1.JUMP_JET_VARIANTS).forEach(([type, variant]) => {
    const jumpJetType = type;
    const config = { [jumpJetType]: 4 };
    const cost = (0, jumpJetCalculations_1.calculateJumpJetCost)(config);
    console.log(`${variant.name}: ${(cost / 1000000).toFixed(1)}M C-Bills for 4 units`);
});
console.log('\n\n🎮 Testing Technology Availability:');
console.log('===================================');
const techBases = ['Inner Sphere', 'Clan'];
const rulesLevels = ['Standard', 'Advanced', 'Experimental'];
techBases.forEach(techBase => {
    console.log(`\n${techBase}:`);
    rulesLevels.forEach(rulesLevel => {
        const available = (0, jumpJetCalculations_1.getAvailableJumpJetTypes)(techBase, rulesLevel);
        console.log(`  ${rulesLevel}: ${available.length} types available`);
        available.forEach(type => {
            const variant = jumpJetCalculations_1.JUMP_JET_VARIANTS[type];
...
const edge1 = (0, jumpJetCalculations_1.validateJumpJetConfiguration)({}, 4, 4, 6, 50);
...
const edge2 = (0, jumpJetCalculations_1.validateJumpJetConfiguration)({ 'Partial Wing': 1 }, 0, 4, 6, 50);
...
const edge3 = (0, jumpJetCalculations_1.validateJumpJetConfiguration)({ 'Standard Jump Jet': 2 }, 4, 4, 6, 50);
...
const edge4 = (0, jumpJetCalculations_1.validateJumpJetConfiguration)({ 'Standard Jump Jet': 6 }, 6, 4, 6, 50);
