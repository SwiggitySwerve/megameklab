...
const EquipmentTabV2: React.FC<{ readOnly?: boolean }> = ({ readOnly = false }) => {
  ...
  return (
    <div className="p-4 max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-6 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`font-medium ${
                  equipmentStats.totalWeight > remainingWeight ? 'text-red-400' : 'text-slate-200'
                }`}>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`font-medium ${
                  equipmentStats.totalSlots > remainingSlots ? 'text-red-400' : 'text-slate-200'
                }`}>
      ...
      {/* Content Area - Equipment Browser */}
