...
import CriticalsTabUpdated from '../components/editor/tabs/CriticalsTabUpdated';
...
const testUnit: EditableUnit = {
  ...
  data: {
    ...
    criticals: [
      ...
      { location: 'Left Torso', slots: ['Engine', 'Engine', 'Engine', '-Empty-', '-Empty-', '-Empty-', '-Empty-', '-Empty-', '-Empty-', '-Empty-', '-Empty-', '-Empty-'] as any },
      { location: 'Center Torso', slots: ['Engine', 'Engine', 'Engine', 'Gyro', 'Gyro', 'Gyro', 'Gyro', '-Empty-', '-Empty-', '-Empty-', '-Empty-', '-Empty-'] as any },
      { location: 'Right Torso', slots: ['Engine', 'Engine', 'Engine', '-Empty-', '-Empty-', '-Empty-', '-Empty-', '-Empty-', '-Empty-', '-Empty-', '-Empty-', '-Empty-'] as any },
...
const TestCriticalsTab: React.FC = () => {
  ...
  return (
    <div className={styles.container}>
      <h1>Test Criticals Tab - Full Drag & Drop Implementation</h1>
      
      <UnitDataProvider initialUnit={testUnit} onUnitChange={handleUnitChange}>
        <CriticalsTabUpdated readOnly={false} />
      </UnitDataProvider>
      
      <div style={{ marginTop: '2rem', padding: '1rem', background: '#1e293b', borderRadius: '0.5rem' }}>
        <h3>Features</h3>
        <ul>
          <li>✅ Object-based critical slot system</li>
          <li>✅ Drag equipment from unallocated list to slots</li>
          <li>✅ Drag equipment between slots</li>
          <li>✅ Visual feedback (green for valid drops, red for invalid)</li>
          <li>✅ Multi-slot equipment support (AC/20 takes 10 slots)</li>
          <li>✅ Equipment disappears from available list when placed</li>
          <li>✅ Equipment reappears when removed</li>
          <li>✅ Fixed system components cannot be moved</li>
          <li>✅ Click to remove equipment</li>
          <li>✅ Clear location button (removes non-fixed items)</li>
          <li>✅ Real-time slot statistics</li>
        </ul>
      </div>
    </div>
  );
...
export default TestCriticalsTab;
